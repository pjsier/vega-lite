...
perl -pi -e s,'ValueDef(.*)<Value>','TextValueDef\1',g build/vega-lite-schema.json
...
perl -pi -e s,'FieldDefWithCondition<FieldDefWithoutScale>','FieldDefWithCondition',g build/vega-lite-schema.json
perl -pi -e s,'ValueDefWithCondition<FieldDefWithoutScale>','ValueDefWithCondition',g build/vega-lite-schema.json
